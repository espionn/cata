...
export const BMRotationConfig = {
	inputs: [
		...
		InputHelpers.makeRotationEnumInput<Spec.SpecBeastMasteryHunter, StingType>({
			fieldName: 'sting',
			label: i18n.t('rotation.options.hunter.beast_mastery.sting.label'),
			labelTooltip: i18n.t('rotation.options.hunter.beast_mastery.sting.tooltip'),
			values: [
				{ name: i18n.t('rotation.options.hunter.beast_mastery.sting.values.none'), value: StingType.NoSting },
				{ name: i18n.t('rotation.options.hunter.beast_mastery.sting.values.serpent_sting'), value: StingType.SerpentSting },
			],
		...
		InputHelpers.makeRotationBooleanInput<Spec.SpecBeastMasteryHunter>({
			fieldName: 'trapWeave',
			label: i18n.t('rotation.options.hunter.beast_mastery.trap_weave.label'),
			labelTooltip: i18n.t('rotation.options.hunter.beast_mastery.trap_weave.tooltip'),
		}),
		InputHelpers.makeRotationBooleanInput<Spec.SpecBeastMasteryHunter>({
			fieldName: 'multiDotSerpentSting',
			label: i18n.t('rotation.options.hunter.beast_mastery.multi_dot_serpent_sting.label'),
			labelTooltip: i18n.t('rotation.options.hunter.beast_mastery.multi_dot_serpent_sting.tooltip'),
